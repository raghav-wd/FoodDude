...
{
    $sql = "insert into `orders`(`order_no`,`paid`, `room_no`, `phno`, `maggi`, `oreo`, `kurkure`, `lays`, `p_meth`, `time`, `pickup`) values('$order_no', '$paid', '$room_no', '$phno', '$Maggi_nos', '$Oreo_nos', '$Kurkure_nos', '$Lays_nos', '$p_meth', '$time', '$pickup')";
    $res = mysqli_query($conn, $sql);
}
